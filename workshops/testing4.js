...
function map(array, fun) {
  ...
  array.forEach(element => { 
    // console.log(element);
    mappedArray.push(fun(element));
    });
  return mappedArray;
}
const mapArray2 = map(numberArray, ((x) => x+1));
console.log("map fn:", mapArray2);
...
console.log("filter fn:", filterArray2);

// every
const everyPositive1 = numberArray.every((x) => x >0);
const everyNegative1 = numberArray.every((x) => x <0);
console.log("every +:", everyPositive1);
console.log("every -:", everyNegative1);
...
console.log("every fn +:", everyPositive2);
console.log("every fn -", everyNegative2);

// some
const someGT21 = numberArray.some((x) => x >2);
const someLT01 = numberArray.some((x) => x <0);
console.log("some >2:", someGT21);
console.log("some <0:", someLT01);
...
console.log("some fn >2:", someGT22);
console.log("some fn <0:", someLT02);
...
console.log("found fn:", found2);

// reduce
const reduced1 = numberArray.reduce((total, x) => total + x, 0);
console.log("reduce:", reduced1);
...
console.log("reduce fn: ", reduced2);

// flat
const flattened1 = unflatArray.flat();
const flattened2 = unflatArray.flat(2);
console.log("flat:", flattened1);
console.log("flat:", flattened2);
